...
import chardet
import sqlglot
def strip_semantics(sql,read='mysql'):
    # 解析 SQL 语句为语法树
    try:
...
def parse_sql(sql):
    ...
    try:
        ...
        parsed_sql = strip_semantics(sql,read='mysql')
        print("sdfsdf")
        print(sql)
...
if __name__ == "__main__":
    test_directory = 'E:\your PhD\毕设\sqlglot\Squirrel\data\\fuzz_root\mysql_init_lib'  # 请将此路径替换为 PostgreSQL 源码中 test 目录的实际路径
    output_filename = 'mysql_seed.txt'
